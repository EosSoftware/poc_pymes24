        ...
        if (0 != e.length) {
          var t = {
            ...
            datasets: [{
              ...
              data: [15, 40, 25, 60, 25, 20, 15, 20, 25, 30, 0, 20, 50, 10, 15, 20]
            }, {
              backgroundColor: "#aaaaaf",
              data: [15, 0, 25, 0, 25, 20, 15, 20, 25, 30, 50, 20, 0, 10, 15, 20]
            }]
          };
          new Chart(e, {
            type: "bar",
      ...
      function() {
        ...
        function() {
          ...
          function a(e, t, a) {
            var r = "",
              o = "";
            t - e < 100 || "Today" == a ? (r = "Today:", o = e.format("MMM D")) : "Yesterday" == a ? (r = "Yesterday:", o = e.format("MMM D")) : o = e.format("MMM D") + " - " + t.format("MMM D"), n.find(".m-subheader__daterange-date").html(o), n.find(".m-subheader__daterange-title").html(r)
          }
